...
else{document.body.className='theme-white  pace-done fixed-header fixed-leftmenu';}}
catch(e){document.body.className='theme-white  pace-done fixed-header fixed-leftmenu';}}
else{document.body.className='theme-white  pace-done fixed-header fixed-leftmenu';}