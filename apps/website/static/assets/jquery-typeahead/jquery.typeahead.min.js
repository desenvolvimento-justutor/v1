...
!function (t) {
    ...
    window.Typeahead = {version: "2.3.4"};
    var e = {
        input: null,
        minLength: 2,
        maxItem: 8,
    ...
    }, n = ~navigator.appVersion.indexOf("MSIE 9."), s = function (t, e) {
    ...
    s.prototype = {
        extendOptions: function () {
            ...
            if (this.options.source instanceof Array)return this.options.source = {group: {data: this.options.source}}, this.groupCount += 1, !0;
            ("undefined" != typeof this.options.source.data || "undefined" != typeof this.options.source.url) && (this.options.source = {group: this.options.source});
            var t;
            for (var e in this.options.source)if (this.options.source.hasOwnProperty(e)) {
                if (t = this.options.source[e], ("string" == typeof t || t instanceof Array) && (t = {url: t}), !t.data && !t.url)return !1;
            ...
            var e = this, o = ["focus" + i, "input" + i, "propertychange" + i, "keydown" + i, "keyup" + i, "dynamic" + i, "generateOnLoad" + i];
            this.container.off(i).on("click" + i + " touchstart" + i, function (i) {
                e.options.dropdownFilter && e.container.hasClass("filter") && !t(i.target).closest("." + e.options.selector.dropdown.replace(" ", "."))[0] && e.container.removeClass("filter")
            ...
            var s = !1;
            this.node.off(i).on(o.join(" "), function (t) {
                switch (t.type) {
                    case"focus":
                    ...
                    case"keydown":
                        null !== e.isGenerated || e.options.dynamic || e.generateSource(), t.keyCode && ~[9, 13, 27, 38, 39, 40].indexOf(t.keyCode) && (s = !0, e.navigate(t));
                        break;
                    case"keyup":
            ...
            if (!this.isGenerated || this.options.dynamic) {
                ...
                var e, i, o, n;
                for (e in this.options.source)if (this.options.source.hasOwnProperty(e)) {
                    if (i = this.options.source[e], this.options.cache && (o = window[this.options.cache].getItem("TYPEAHEAD_" + this.node.selector + ":" + e))) {
                        this.options.compression && (o = LZString.decompressFromUTF16(o)), n = !1;
                        try {
                            o = JSON.parse(o + ""), o.data && o.ttl > (new Date).getTime() ? (this.populateSource(o.data, e), n = !0) : window[this.options.cache].removeItem("TYPEAHEAD_" + this.node.selector + ":" + e)
                        } catch (s) {
                        }
                        if (n)continue
                    }
            ...
            var i = this, o = this.options.source[e];
            o.url instanceof Array || (o.url = [o.url]);
            var n = {
                request: {
                    url: null, dataType: "json", beforeSend: function (t, n) {
                        i.xhr[e] = t;
                        var s = i.requests[e].extra.beforeSend || o.url[0].beforeSend;
                        "function" == typeof s && s.apply(null, arguments)
                    }
                },
                extra: {path: null, group: e, callback: {done: null, fail: null, complete: null, always: null}},
                validForGroup: [e]
            };
            Object.defineProperty(n.request, "beforeSend", {writable: !1}), o.url[0] instanceof Object ? (o.url[0].callback && (n.extra.callback = o.url[0].callback, delete o.url[0].callback), n.request = t.extend(!0, n.request, o.url[0])) : "string" == typeof o.url[0] && (n.request.url = o.url[0]), o.url[1] && "string" == typeof o.url[1] && (n.extra.path = o.url[1]), "jsonp" === n.request.dataType.toLowerCase() && (n.request.jsonpCallback = "callback_" + e);
            var s;
            for (var r in this.requests)if (this.requests.hasOwnProperty(r) && (s = JSON.stringify(this.requests[r].request), s === JSON.stringify(n.request))) {
                this.requests[r].validForGroup.push(e), n.isDuplicated = !0, delete n.validForGroup;
                break
            }
            return n
            ...
            for (var o in this.requests)this.requests.hasOwnProperty(o) && (this.requests[o].isDuplicated || !function (o, n) {
                if ("function" == typeof e.options.source[o].url[0]) {
                    var s = e.options.source[o].url[0].call(e, e.query);
                    if (n.request = t.extend(!0, n.request, s), "object" != typeof n.request || !n.request.url)return;
                    s.beforeSend && (e.requests[o].extra.beforeSend = s.beforeSend)
                }
                var r, a = !1;
                if (~n.request.url.indexOf("{{query}}") && (a || (n = t.extend(!0, {}, n), a = !0), n.request.url = n.request.url.replace("{{query}}", e.query.sanitize())), n.request.data)for (var l in n.request.data)if (n.request.data.hasOwnProperty(l) && ~String(n.request.data[l]).indexOf("{{query}}")) {
                    a || (n = t.extend(!0, {}, n), a = !0), n.request.data[l] = n.request.data[l].replace("{{query}}", e.query.sanitize());
                    break
                }
                t.ajax(n.request).done(function (t, o, s) {
                    for (var a, l = 0; l < n.validForGroup.length; l++)r = e.requests[n.validForGroup[l]], r.extra.callback.done instanceof Function && (a = r.extra.callback.done(t, o, s), t = a instanceof Array && a || t), e.populateSource(t, r.extra.group, r.extra.path), i -= 1, 0 === i && e.helper.executeCallback.call(e, e.options.callback.onReceiveRequest, [e.node, e.query])
                }).fail(function (t, i, o) {
                    for (var s = 0; s < n.validForGroup.length; s++)r = e.requests[n.validForGroup[s]], r.extra.callback.fail instanceof Function && r.extra.callback.fail(t, i, o)
                }).then(function (t, i) {
                    for (var o = 0; o < n.validForGroup.length; o++)r = e.requests[n.validForGroup[o]], r.extra.callback.then instanceof Function && r.extra.callback.then(t, i)
                }).always(function (t, i, o) {
                    for (var s = 0; s < n.validForGroup.length; s++)r = e.requests[n.validForGroup[s]], r.extra.callback.always instanceof Function && r.extra.callback.always(t, i, o)
                })
            }(o, this.requests[o]))
        }, populateSource: function (t, e, i) {
            var o = this, n = this.options.source[e], s = n.url && n.data;
            t = "string" == typeof i ? this.helper.namespace(i, t) : t, t instanceof Array || (t = []), s && ("function" == typeof s && (s = s()), s instanceof Array && (t = t.concat(s)));
            for (var r, a = n.display ? "compiled" === n.display[0] ? n.display[1] : n.display[0] : "compiled" === this.options.display[0] ? this.options.display[1] : this.options.display[0], l = 0; l < t.length; l++)"string" == typeof t[l] && (r = {}, r[a] = t[l], t[l] = r), t[l].group = e;
            if (this.options.correlativeTemplate) {
                var h = n.template || this.options.template, u = "";
                if ("function" == typeof h && (h = h()), h) {
                    if (this.options.correlativeTemplate instanceof Array)for (var l = 0; l < this.options.correlativeTemplate.length; l++)u += "{{" + this.options.correlativeTemplate[l] + "}} "; else u = h.replace(/<.+?>/g, "");
                    for (var l = 0; l < t.length; l++)t[l].compiled = u.replace(/\{\{([\w\-\.]+)(?:\|(\w+))?}}/g, function (e, i) {
            ...
            if (this.options.callback.onPopulateSource && (t = this.helper.executeCallback.call(this, this.options.callback.onPopulateSource, [this.node, t, e, i])), this.tmpSource[e] = t, this.options.cache && !window[this.options.cache].getItem("TYPEAHEAD_" + this.node.selector + ":" + e)) {
                ...
                var c = JSON.stringify({data: t, ttl: (new Date).getTime() + this.options.ttl});
                this.options.compression && (c = LZString.compressToUTF16(c)), window[this.options.cache].setItem("TYPEAHEAD_" + this.node.selector + ":" + e, c)
            }
            ...
            if (this.isGenerated && this.result.length) {
                var e = this.resultContainer.find("> ul > li:not([data-search-group])"), i = e.filter(".active"), o = i[0] && e.index(i) || null, n = null;
                if (13 === t.keyCode) {
            ...
            if (t || (this.item = {}), this.resetLayout(), this.helper.executeCallback.call(this, this.options.callback.onSearch, [this.node, this.query]), !(this.query.length < this.options.minLength)) {
                var e, i, o, n, s, r, a, l, h, u, c, p, d = this, f = this.options.group && "boolean" != typeof this.options.group[0] ? this.options.group[0] : "group", y = null, g = this.query.toLowerCase(), m = this.options.maxItemPerGroup, v = this.filters.dynamic && !this.helper.isEmpty(this.filters.dynamic), b = "function" == typeof this.options.matcher && this.options.matcher;
                this.options.accent && (g = this.helper.removeAccent.call(this, g));
                for (e in this.source)if (this.source.hasOwnProperty(e) && (!this.filters.dropdown || "group" !== this.filters.dropdown.key || this.filters.dropdown.value === e)) {
                    r = "undefined" != typeof this.options.source[e].filter ? this.options.source[e].filter : this.options.filter, l = "function" == typeof this.options.source[e].matcher && this.options.source[e].matcher || b;
                    for (var k = 0; k < this.source[e].length && (!(this.result.length >= this.options.maxItem) || this.options.callback.onResult); k++)if (!v || this.dynamicFilter.validate.apply(this, [this.source[e][k]])) {
                        if (i = this.source[e][k], y = "group" === f ? e : i[f], y && !this.result[y] && (this.result[y] = [], this.resultCountPerGroup[y] = 0), m && "group" === f && this.result[y].length >= m && !this.options.callback.onResult)break;
                        s = this.options.source[e].display || this.options.display;
                        for (var C = 0; C < s.length; C++) {
                            if ("function" == typeof r) {
                                if (a = r.call(this, i, i[s[C]]), void 0 === a)break;
                                if (!a)continue;
                                "object" == typeof a && (i = a)
                            }
                            if (~[void 0, !0].indexOf(r)) {
                                if (n = i[s[C]], !n)continue;
                                if (n = n.toString().toLowerCase(), this.options.accent && (n = this.helper.removeAccent.call(this, n)), o = n.indexOf(g), this.options.correlativeTemplate && "compiled" === s[C] && 0 > o && /\s/.test(g)) {
                                    u = !0, c = g.split(" "), p = n;
                                    for (var w = 0; w < c.length; w++)if ("" !== c[w]) {
                                        if (!~p.indexOf(c[w])) {
                                            u = !1;
                                            break
                                        }
                                ...
                                if (l) {
                                    if (h = l.call(this, i, i[s[C]]), void 0 === h)break;
                                    if (!h)continue;
                                    "object" == typeof h && (i = h)
                                }
                            }
                            if (!this.filters.dropdown || this.filters.dropdown.value == i[this.filters.dropdown.key]) {
                                if (this.resultCount++, this.resultCountPerGroup[y]++, this.resultItemCount < this.options.maxItem) {
                                    ...
                                    i.matchedKey = s[C], this.result[y].push(i), this.resultItemCount++
                                }
                                break
                            }
                        }
                ...
                if (this.options.order) {
                    var x, s = [];
                    for (var e in this.result)if (this.result.hasOwnProperty(e)) {
                        for (var C = 0; C < this.result[e].length; C++)x = this.options.source[this.result[e][C].group].display || this.options.display, ~s.indexOf(x[0]) || s.push(x[0]);
                        this.result[e].sort(d.helper.sort(s, "asc" === d.options.order, function (t) {
                            return t.toString().toUpperCase()
                        }))
                    }
                }
                var q, O = [];
                q = "function" == typeof this.options.groupOrder ? this.options.groupOrder.apply(this, [this.node, this.query, this.result, this.resultCount, this.resultCountPerGroup]) : this.options.groupOrder instanceof Array ? this.options.groupOrder : "string" == typeof this.options.groupOrder && ~["asc", "desc"].indexOf(this.options.groupOrder) ? Object.keys(this.result).sort(d.helper.sort([], "asc" === d.options.groupOrder, function (t) {
                    return t.toString().toUpperCase()
                })) : Object.keys(this.result);
                for (var C = 0; C < q.length; C++)O = O.concat(this.result[q[C]] || []);
                this.result = O, this.helper.executeCallback.call(this, this.options.callback.onResult, [this.node, this.query, this.result, this.resultCount, this.resultCountPerGroup])
            }
            ...
            if (this.buildHtmlLayout(), this.buildBackdropLayout(), this.buildHintLayout(), this.options.callback.onLayoutBuiltBefore) {
                ...
                t instanceof jQuery && (this.resultHtml = t)
            }
            ...
            if (this.options.resultContainer !== !1) {
                ...
                var i = this;
                this.resultHtml = t("<ul/>", {
                    "class": this.options.selector.list + (i.helper.isEmpty(i.result) ? " empty" : ""),
                    html: function () {
                        if (i.options.emptyTemplate && i.helper.isEmpty(i.result)) {
                            var o = "function" == typeof i.options.emptyTemplate ? i.options.emptyTemplate.call(i, i.query) : i.options.emptyTemplate.replace(/\{\{query}}/gi, i.query.sanitize());
                            return o instanceof jQuery && "LI" === o[0].nodeName ? o : t("<li/>", {
                                "class": i.options.selector.empty,
                                html: t("<a/>", {href: "javascript:;", html: o})
                            })
                        }
                        for (var n in i.result)i.result.hasOwnProperty(n) && !function (o, n, s) {
                            var r, a, l, h, u = n.group, c = [], p = i.options.source[n.group].display || i.options.display, d = i.options.source[n.group].href || i.options.href;
                            i.options.group && (i.options.group[1] ? "function" == typeof i.options.group[1] ? u = i.options.group[1](n) : "string" == typeof i.options.group[1] && (u = i.options.group[1].replace(/(\{\{group}})/gi, n[i.options.group[0]] || u)) : "boolean" != typeof i.options.group[0] && n[i.options.group[0]] && (u = n[i.options.group[0]]), t(s).find('li[data-search-group="' + u + '"]')[0] || t(s).append(t("<li/>", {
                                "class": i.options.selector.group,
                                html: t("<a/>", {href: "javascript:;", html: u}),
                                "data-search-group": u
                            }))), r = t("<li/>", {
                                "class": i.options.selector.item, html: t("<a/>", {
                                    href: function () {
                                        return d && ("string" == typeof d ? d = d.replace(/\{\{([\w\-\.]+)(?:\|(\w+))?}}/g, function (t, e, o) {
                                            var s = i.helper.namespace(e, n, "get", "");
                                            return o && "slugify" === o && (s = i.helper.slugify.call(i, s)), s
                                        }) : "function" == typeof d && (d = d(n)), n.href = d), d || "javascript:;"
                                    }, "data-group": u, "data-index": o, html: function () {
                                        if (h = n.group && i.options.source[n.group].template || i.options.template)"function" == typeof h && (h = h.call(i, i.query, n)), a = h.replace(/\{\{([\w\-\.]+)(?:\|(\w+))?}}/g, function (t, o, s) {
                                            var r = String(i.helper.namespace(o, n, "get", "")).sanitize();
                                            return s && "raw" === s || i.options.highlight === !0 && e && ~p.indexOf(o) && (r = i.helper.highlight.call(i, r, e.split(" "), i.options.accent)), r
                                        }); else {
                                            for (var o = 0; o < p.length; o++)c.push(n[p[o]]);
                                            a = '<span class="' + i.options.selector.display + '">' + String(c.join(" ")).sanitize() + "</span>"
                                        }
                                        (i.options.highlight === !0 && e && !h || "any" === i.options.highlight) && (a = i.helper.highlight.call(i, a, e.split(" "), i.options.accent)), t(this).append(a)
                                    }, click: function (e) {
                            ...
                            }), i.options.group ? (l = t(s).find('a[data-group="' + u + '"]:last').closest("li"), l[0] || (l = t(s).find('li[data-search-group="' + u + '"]')), t(r).insertAfter(l)) : t(s).append(r)
                        }(n, i.result[n], this)
                    }
                })
            }
            ...
            if (this.options.hint) {
                if (this.node[0].scrollWidth > this.node.innerWidth())return void this.hint.container.val("");
                ...
                if (this.options.accent && (n = this.helper.removeAccent.call(this, n)), this.hintIndex = null, this.query.length >= this.options.minLength) {
                    if (this.hint.container || (this.hint.css = t.extend({
                        ...
                        }).addClass(this.options.selector.hint).css(this.hint.css).insertAfter(this.node), this.node.parent().css({position: "relative"})), this.hint.container.css("color", this.hint.css.color), n)for (var s, r, a, l = 0; l < e.length; l++) {
                        r = e[l].group, s = this.options.source[r].display || this.options.display;
                        for (var h = 0; h < s.length; h++)if (a = String(e[l][s[h]]).toLowerCase(), this.options.accent && (a = this.helper.removeAccent.call(this, a)), 0 === a.indexOf(n)) {
                            o = String(e[l][s[h]]), this.hintIndex = l;
                            break
                        }
                ...
                t("<span/>", {
                    "class": this.options.selector.filter, html: function () {
                        t(this).append(t("<button/>", {
                            ...
                            html: "<span class='" + n.options.selector.filterValue + "'>" + o + "</span> <span class='" + n.options.selector.dropdownCaret + "'></span>",
                            click: function (e) {
                                e.stopPropagation(), n.container.toggleClass("filter");
                                var o = i + "-dropdown-filter";
                                t("html").off(o), n.container.hasClass("filter") && t("html").one("click" + o + " touchstart" + o, function () {
                                    n.container.removeClass("filter")
                                })
                            }
                        })), t(this).append(t("<ul/>", {
                            "class": n.options.selector.dropdown, html: function () {
                                var i = n.options.dropdownFilter;
                                if (~["string", "boolean"].indexOf(typeof n.options.dropdownFilter)) {
                                    i = [];
                                    for (var o in n.options.source)n.options.source.hasOwnProperty(o) && i.push({
                                        key: "group",
                                        value: o
                                    });
                                    i.push({
                                ...
                                for (var s = 0; s < i.length; s++)!function (i, o, s) {
                                    (o.key || "*" === o.value) && o.value && ("*" === o.value && t(s).append(t("<li/>", {"class": "divider"})), t(s).append(t("<li/>", {
                                        html: t("<a/>", {
                                            href: "javascript:;",
                                            html: o.display || o.value,
                                            click: function (t) {
                                                t.preventDefault(), e.apply(n, [o])
                                            }
                                        })
                                    })))
                                }(s, i[s], this)
            ...
            validate: function (t) {
                ...
                if (this.options.dynamicFilter)for (var e, o = this, n = 0; n < this.options.dynamicFilter.length; n++)e = this.options.dynamicFilter[n], "string" == typeof e.selector && (e.selector = t(e.selector)), e.selector instanceof jQuery && e.selector[0] && e.key && !function (t) {
                    t.selector.off(i).on("change" + i, function () {
                        o.dynamicFilter.set.apply(o, [t.key, o.dynamicFilter.getValue(this)])
                    }).trigger("change" + i)
                }(e)
            }, getValue: function (t) {
                var e;
            ...
            if (!this.container.hasClass("result") && (this.result.length || this.options.emptyTemplate || this.options.backdropOnFocus)) {
                var e = this;
                t("html").off(i).on("click" + i + " touchstart" + i, function (i) {
                    t(i.target).closest(e.container)[0] || e.hideLayout()
            ...
            this.result = {}, this.resultCount = 0, this.resultCountPerGroup = {}, this.resultItemCount = 0, this.resultHtml = null, this.resultContainer && this.resultContainer.html(""), this.options.hint && this.hint.container && this.hint.container.val("")
            ...
            isEmpty: function (t) {
                ...
                var o = function (e) {
                    for (var o = 0; o < t.length; o++)if ("undefined" != typeof e[t[o]])return i(e[t[o]]);
                    return e
                };
                ...
                if (!t)return !1;
                var i;
                if ("function" == typeof t)i = t; else if (("string" == typeof t || t instanceof Array) && ("string" == typeof t && (t = [t, []]), i = this.helper.namespace(t[0], window), "function" != typeof i))return !1;
    ...
    var r = {
        typeahead: function (e, i) {
            if (i && i.source && "object" == typeof i.source) {
                ...
                if (e.length && "INPUT" === e[0].nodeName)for (var o, n = 0; n < e.length; n++)o = 1 === e.length ? e : t(e.selector.split(",")[n].trim()), window.Typeahead[o.selector || i.input] = new s(o, i)
            }
        }
    };
    return "sanitize" in String.prototype || (String.prototype.sanitize = function () {
        var t = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;"};
